...
- Применяй `reusable-agent-system-toolkit/references/untrusted-content-security.md` при bootstrap и соответствующий project-local security contract после установки.
