...
async function initPushNotifications() {
  ...
  PushNotifications.addListener('registration', (token) => {
    // Never log or persist this credential-like identifier. Send it only to
    // your authenticated first-party backend.
  ...
  PushNotifications.addListener('pushNotificationReceived', (notification) => {
    // Payloads may contain personal data; log only redacted event metadata.
  ...
  PushNotifications.addListener('pushNotificationActionPerformed', (action) => {
    // Do not log the full action or notification payload.
