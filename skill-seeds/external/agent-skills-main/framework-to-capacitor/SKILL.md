...
npm exec --no -- cap add ios
npm exec --no -- cap add android
```
...
**Create new project:**
```bash
npm exec --no -- create-vite@latest my-app --template react-ts
cd my-app
npm install
```
...
**Create new project:**
```bash
npm exec --no -- create-react-app my-app --template typescript
cd my-app
```
...
**Using Vite:**
```bash
npm exec --no -- create-vite@latest my-app --template vue-ts
cd my-app
npm install
```
...
**Create Angular app:**
```bash
npm exec --no -- @angular/cli new my-app
cd my-app
```
...
```bash
npm exec --no -- create-svelte my-app
cd my-app
npm install
```
...
**Create with Vite:**
```bash
npm exec --no -- create-vite@latest my-app --template svelte-ts
cd my-app
npm install
```
