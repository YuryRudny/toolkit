...
```bash
# GitHub shorthand
npm exec --no -- skills add Kadajett/agent-nestjs-skills

# Install globally (available across all projects)
npm exec --no -- skills add Kadajett/agent-nestjs-skills --global

# Install for specific agents
npm exec --no -- skills add Kadajett/agent-nestjs-skills -a claude-code -a cursor
```
